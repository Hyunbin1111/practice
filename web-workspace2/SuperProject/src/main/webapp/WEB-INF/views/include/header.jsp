    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="/super">HOME</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#">공지사항</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="list.board?currentPage=1">게시판</a>
          </li>
          <li class="nav-item">
...
<div class="modal fade" id="log-in">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<!-- 
				=> http://localhost/super/login.me(서블릿 매핑값)
				
				form태그 안에 존재하는 submit버튼 클릭 했을 때
				...
				* 경로 지정 방식
				...
				1. 절대 경로 방식(/) :/contextroot/요청할 URL
								  TOMCAT포트 뒤 localhost:80 뒤에 action에 작성한 값이 붙으면서 요청
								  
				2. 상대 경로 방식(매핑값) : / 없이 시작되는 경우
									  현재 이 페이지에 보여지는 URL경로중에 
