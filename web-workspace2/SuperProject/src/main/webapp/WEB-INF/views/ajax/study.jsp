  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
	...
	<pre>
		...
		* 주요속성
		...
		- data	   : 요청 시 전달값 ({키:밸류, 키:밸류}) form태그의 input요소에 입력할 값
	...
	<h4>1. 버튼 클릭 시 GET방식으로 서버에 데이터 전송 및 응답</h3>
	...
	<script>
		...
		$('#ajax-btn').click(function(){
			...
			// 동기식 요청 : loaction.href = '요청URL?쿼리스트링';
	...
	<button onclick="ajaxFunction()">요청하기</button>
