	...
	<div style="width : 80%; margin : auto; padding : 50px;">
		<form action="sign-up.me" name="signup" id="signUpForm" method="post"
			...
			<table
				...
				<tr>
					<td><laber id="id-result"></laber></td>
				</tr>
				<tr>
					<td style="text-align: left">
				...
				<tr>
					<td id="hobby-wrap">
						...
						<input type="checkbox" id="farming" value="농사" name="">&nbsp;<label for="farming">농사</label>
						<input type="checkbox" id="web" value="web" name="">&nbsp;<label for="tea">웹</label>
						<input type="checkbox" id="java" value="자바" name="">&nbsp;<label for="java">자바</label>
					</td>
				</tr>
